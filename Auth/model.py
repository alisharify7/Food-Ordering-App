...
class User(BaseModel):
    ...
    national_code: so.Mapped[str] = so.mapped_column(sa.String(10), unique=True, nullable=False)
    ...
    email_address: so.Mapped[str] = so.mapped_column(sa.String(320), nullable=True, unique=False)
