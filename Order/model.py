...
Food2ReserveDay = sa.Table(
    ...
    sa.Column(
        "food_menu_id",
        sa.INTEGER,
        sa.ForeignKey(BaseModel.SetTableName("food_menu") + ".id"),
        nullable=False,
    ),
    sa.Column(
        "food_reserve_day_id",
        sa.INTEGER,
        sa.ForeignKey(BaseModel.SetTableName("food_reserve_day") + ".id"),
        nullable=False,
    ),
)
...
Order2FoodPrice = sa.Table(
    ...
    sa.Column(
        "order_id",
        sa.INTEGER,
        sa.ForeignKey(BaseModel.SetTableName("orders") + ".id"),
        nullable=False,
    ),
)
